...
void WinScreenState::render()
{
	...
	SDL_Surface* textSurface = TTF_RenderText_Blended(font, "You Win!!!", textColor);
...
bool WinScreenState::onEnter()
{
	cout << "Enter Gameplay state" << endl;
	return true;
}

bool WinScreenState::onExit()
{
